...
if __name__ == '__main__':
    ...
    Feed(name="schneier-official", title="Schneier on Security", site="http://www.eff.org/", url="http://feeds.feedburner.com/schneier/excerpts", search=FeedSearch(attribute="title", value="TSA")).save()
